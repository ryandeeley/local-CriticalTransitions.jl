...
RateSystem(f, pf, L, T_trans, T_shift, u) = RateSystem(f, pf, L, T_trans, T_shift, u, 1.0, idfunc, nothing, I(dim), "WhiteGauss")
RateSystem(f, pf, L, T_trans, T_shift, u, σ) = RateSystem(f, pf, L, T_trans, T_shift, u, σ, idfunc, nothing, I(dim), "WhiteGauss")
RateSystem(f, pf, L, T_trans, T_shift, u, σ, Σ) = RateSystem(f, pf, L, T_trans, T_shift, u, σ, idfunc, nothing, Σ, "WhiteGauss")
...
stochtorate(sys::StochSystem,td_inds::Vector{Bool},L::Function,pL::Vector,T_trans::Float64,T_shift::Float64)=RateSystem(sys.f,sys.pf,td_inds,L,pL,T_trans,T_shift,sys.u,sys.σ,sys.g,sys.pg,sys.Σ,sys.process)
